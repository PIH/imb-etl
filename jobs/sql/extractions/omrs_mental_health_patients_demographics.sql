CREATE temporary table temp_mental_health_patients_demographics (
...
# Populate the "rows" of this table to contain all Mental Health patients
insert into temp_mental_health_patients_demographics(Patient_UUID,patient_id,Medical_Record_Number,Patient_Names,
...
from patient_program pp
         inner join temp_mental_health_patients_demographics t on pp.patient_id = t.patient_id
where pp.voided = 0 and pp.program_id= (select program_id from program where name="Mental Health")
;
...
update temp_mental_health_patients_demographics tdpd
 set
    tdpd.Enrolment_Date =
    (
        SELECT
        ...
        where
            ...
            and ppro.program_id=(select program_id from program where name="Mental Health")
...
select * from temp_mental_health_patients_demographics;